...
#use with option --input-json from command line
json_get_opt() {
	__arg1=""; __arg2=""; __arg3=""; __arg4=""; __arg5="";
...
#import all files from $FUNCTION_PATH
